...
#if ((CONFIG_AUDIO_SOURCE_USB || CONFIG_AUDIO_SINK_USB) && !CONFIG_AUDIO_SAMPLE_RATE_48000_HZ &&   \
...
#endif /* ((CONFIG_AUDIO_SOURCE_USB || CONFIG_AUDIO_SINK_USB) && !CONFIG_AUDIO_SAMPLE_RATE_48000_HZ) */
