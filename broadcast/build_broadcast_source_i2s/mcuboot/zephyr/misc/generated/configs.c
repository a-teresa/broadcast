...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_IMAGE_ACCESS_HOOK_NRF5340, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF53_MULTI_IMAGE_UPDATE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF53_MCUBOOT_PRIMARY_1_RAM_FLASH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF53_RAM_FLASH_SIZE, 0x40000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_UPGRADE_ONLY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_VERIFY_IMG_ADDRESS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_MCUBOOT_IMG_VALIDATE_ATTEMPT_COUNT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PCD_APP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PCD_VERSION_PAGE_BUF_SIZE, 2046);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PCD_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PCD_LOG_LEVEL, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WIFI_PROV_CORE_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WIFI_PROV_CORE_LOG_LEVEL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_PLATFORM_SNPRINTF_ALT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_PLATFORM_NO_STD_FUNCTIONS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_BOOT_MAX_ALIGN, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_SIMULATOR_DOUBLE_WRITES, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REGULATOR_LOG_LEVEL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_NRFX_UARTE_DIRECT_ISR, 1);
