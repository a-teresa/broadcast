...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_QUEUE_THREAD_STACK_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_QUEUE_THREAD_PRIO, 7);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_MAX_CONN_EVENT_LEN_DEFAULT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CONN_EVENT_EXTEND_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CENTRAL_ACL_EVENT_SPACING_DEFAULT, 30000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_MIN_VAL_OF_MAX_ACL_TX_PAYLOAD_DEFAULT, 27);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_PERIODIC_ADV_EVENT_LEN_DEFAULT, 2500);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_PERIODIC_ADV_LIST_SIZE, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_ISO_RX_PDU_BUFFER_PER_STREAM_COUNT, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_ISO_TX_HCI_BUFFER_COUNT, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_ISO_TX_PDU_BUFFER_PER_STREAM_COUNT, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_COUNT_EXTRA, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_TRIGGER_IPC_TASK_ON_RTC_START, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_TRIGGER_IPC_TASK_ON_RTC_START_CHANNEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_AURASCOPE_NRF5340_CPUNET, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PER_ADV_SYNC_TRANSFER_RECEIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PER_ADV_SYNC_TRANSFER_SENDER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SCA_UPDATE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_UNICAST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_PERIPHERAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_CENTRAL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_MAX_CHAN, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_TX_BUF_COUNT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_MAX_CIG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_MAX_BIG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ISO_RX_BUFFERS, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ISO_TX_BUFFERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ISO_TX_BUFFER_SIZE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ISOAL_SOURCES, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ISOAL_SINKS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ISO_RX_SDU_BUFFERS, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SCA_UPDATE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_INTERVAL_MAX, 0xFFFFFF);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_DATA_LEN_MAX, 251);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_PERIODIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_PERIODIC_ADI_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_PERIODIC_INTERVAL_MAX, 0xFFFF);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_PERIODIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_PERIODIC_ADV_LIST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_PERIODIC_ADI_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_PERIODIC_CTE_TYPE_FILTERING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_TRANSFER_RECEIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_TRANSFER_SENDER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_ISO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_ISO_SEQUENTIAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_ISO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_ISO_SEQUENTIAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_ISO_INTERLEAVED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_BROADCAST_ISO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_ISO_SET, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_ISO_STREAM_MAX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_ISO_STREAM_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_ISO_PDU_LEN_MAX, 251);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SCAN_SYNC_ISO_SET, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_ISO_STREAM_MAX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_ISO_STREAM_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SYNC_ISO_PDU_LEN_MAX, 251);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SET_HOST_FEATURE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_CENTRAL_ISO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_PERIPHERAL_ISO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_CONN_ISO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_CONN_ISO_STREAMS, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_CONN_ISO_GROUPS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_CONN_ISO_STREAMS_PER_GROUP, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_CONN_ISO_PDU_LEN_MAX, 251);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ISO_TX_SDU_LEN_MAX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_CONN_ISO_STREAMS_MAX_NSE, 31);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_CONN_ISO_STREAMS_MAX_FT, 255);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ISO, 1);
