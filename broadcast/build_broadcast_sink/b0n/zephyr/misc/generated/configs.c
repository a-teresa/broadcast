...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_B0N_SIZE, 0x8580);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_CRYPTO_NO_ECDSA_SECP256R1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_CRYPTO_OBERON_SHA256, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FATAL_ERROR_LOG_LEVEL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STREAM_FLASH_LOG_LEVEL, 0);
