...
MEMORY
    {
    FLASH (rx) : ORIGIN = 0x10200, LENGTH = 0xdfe00
...
ztest :
{
 ...
 zbus_channel_area : { _zbus_channel_list_start = .; KEEP(*(SORT_BY_NAME(._zbus_channel.static.*))); _zbus_channel_list_end = .;; } > FLASH
 zbus_observer_area : { _zbus_observer_list_start = .; KEEP(*(SORT_BY_NAME(._zbus_observer.static.*))); _zbus_observer_list_end = .;; } > FLASH
 zbus_channel_observation_area : { _zbus_channel_observation_list_start = .; KEEP(*(SORT_BY_NAME(._zbus_channel_observation.static.*))); _zbus_channel_observation_list_end = .;; } > FLASH
