...
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_flash_simulator_get_params;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_flash_simulator_set_callbacks;
...
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_k_thread_runtime_stack_unused_threshold_get;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_k_thread_runtime_stack_unused_threshold_pct_set;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_k_thread_runtime_stack_unused_threshold_set;
